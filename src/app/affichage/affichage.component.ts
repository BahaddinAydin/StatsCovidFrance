...
import {
  GlobalDataFrance,
  GlobalDataFranceParDepartement,
  keyable,
} from '../models/models';
...
export class AffichageComponent implements OnInit {
  constructor(
    private gdfs: GlobalDataFranceService,
  ...
  DonneeGlobalDuDepartementsChoisieVide = this.DonneeGlobalDuDepartementsChoisie;
  tmp: keyable;
  ngOnInit(): void {
    ...
    this.gdfs.getInfoGlobalByDepartment(departementChoisis)
      .subscribe((donnee) => {
        ...
        Object.keys(this.tmp.allDataByDepartement).forEach((element) => {
          ...
          if (!DonneeExistante) {
             this.DonneeGlobalDuDepartementsChoisie = this.DonneeGlobalDuDepartementsChoisieVide;
          }
        });
        console.log(donnee);
      });
